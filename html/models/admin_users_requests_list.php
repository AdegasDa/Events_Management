...
$sql = "SELECT * FROM `users` WHERE `users`.`user_status` = 0 AND `users`.`user_role` LIKE 'request'";

$sqlcnt = "SELECT COUNT(*) FROM `users` WHERE `users`.`user_status` = 0 AND `users`.`user_role` LIKE 'request'";
