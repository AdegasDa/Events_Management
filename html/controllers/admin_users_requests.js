...
function sidebar(user)
{
    ...
    $("#adm_sidebar").append("<a class='nav-link active' href='#' data-bs-toggle='collapse' data-bs-target='#collapseLayouts' aria-expanded='true' aria-controls='collapseLayouts'> <div class='sb-nav-link-icon'> <i class='fas fa-users'> </i> </div> Users <div class='sb-sidenav-collapse-arrow'> <i class='fas fa-angle-down'> </i> </div> </a> <div class='collapse show' id='collapseLayouts' aria-labelledby='headingOne' data-bs-parent='#sidenavAccordion'> <nav class='sb-sidenav-menu-nested nav'> <a id='adm_users' class='nav-link' href='#'> Active Users </a> <a id='adm_users_deactivated' class='nav-link' href='#'> Deactivated Users </a> <a id='adm_users_requests' class='nav-link active' href='#'> Users Requests </a> </nav> </div>");
...
function body()
{
    admin_users_requests_list();
}

function admin_users_requests_list()
{
    if ( ! $.fn.DataTable.isDataTable('#admin_users_requests_list') )
    {
        $('#admin_users_requests_list').DataTable(
        {
            ...
            ajax:
            {
                url :'../models/admin_users_requests_list.php', // json datasource
                type: 'post'
            }    
        });
    }
    ...
    {
        $('#admin_users_requests_list').DataTable().ajax.reload();
    }
}
...
function button_active(user)
{
    ...
    {
        $.post("../models/admin_users_requests_active.php", { user_id: user['id'] }, function(data)
        {
